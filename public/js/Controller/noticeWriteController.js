...
export default class noticeWriteControoler {
    constructor(type,myGrade){
        ...
        console.log("관리자등급 확인", this._myGrade.grade)
...
grade = async () => {
    ...
    noticeCompleteBtn = async () =>{
        ...
        console.log('resData11',title, content, this._notice)

        //입력한 데이터 넣기
        const resData = await this._noticeModel.postNotice(title, content, this._notice)
        ...
        window.location.href = `/notice__view.html?n=${resData.post_id}`
    }
